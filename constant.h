...
#define W_SENSE_P		30
#define W_SENSE_N		15
#define W_SENSE_ISO		15
#define VBITSENSEMIN	0.08
#define IV_CONVERTER_AREA 5000 //50000 /*TO-DO: technology and design dependent parameter, 649606 is used in PCRAMSim*/
...
#define RES_ADJ 8.6
#define VOL_SWING .1
// from 20 expends to 25
#define CONSTRAINT_ASPECT_RATIO_BANK	25
...
#define SEREACH_PERF_GRAIN 5
#define MIN_SENSE_MARGIN 0.005
#define MAX_PORT 10
#define PRECHARGER_SIZE 30
